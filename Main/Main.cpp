...
{
    // プログラム開始時に外面モードを選択させる。
    static bool s_fullscreen = false;

#if defined(_DEBUG)
    // 画面モード選択
    s_fullscreen = MessageBox(NULL, L"フルスクリーンにしますか？", L"画面モード設定", MB_YESNO) == IDYES;
#else
    s_fullscreen = true;
#endif
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"CatCodeCoreWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"CatCodeCoreWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
            nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"CatCodeCoreWindowClass", g_szAppName, WS_POPUP,
